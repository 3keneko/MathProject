...
\subsection{Un algorithme c'est quoi?}
...
Un des tout premiers exempless d'algorithmes est ``l'agorithme d'Euclide'', celui-ci permettait de trouver le PGCD de deux nombres. \\
...
\begin{itemize}
  ...
  \item Continuer ce procédé jusqu'à ce que la liste soit parfaitement rangée.
\end{itemize}
...
\begin{table}[!hbt]
  ...
  \end{tabular}
\end{table}
Voici le petit tableau montrant les résultats de la dernière expérience, je n'ai malheureusement pas pu essayer pour 1,000,000 d'éléments, le tri à bulles prenant trop de temps. \\
Comme nous pouvons le constater, la complexité d'un algorithme ne mesure pas le temps exact que l'algorithme prendra afin de trier une certaine liste, il s'agit simplement d'un indicateur, montrant comment évoluera le nombre de comparaisons au cours du temps, cet indicateur devenant extrêmement siginificatif quand n devient très grand. \\[0.5cm]
