...
\end{itemize}
Au delà de ses parenthèses, Lisp est réputé pour être un langage élégant, comme le prouve ce comic-strip de XKCD\footnote{Pour l'expérience, nous vous invitons à taper {\bf import antigravity} dans votre interprète python}, se moquant du langage PERL (connu avant tout pour son utilisation massive des REGEX, pouvant rendre les programmes écrit en celui-ci presque illisible pour les non-initiés.)
\begin{figure}[H]
  \centering
