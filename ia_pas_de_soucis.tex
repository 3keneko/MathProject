...
\lstinputlisting[language=Prolog, linerange={108-116}]{PrologExamples/geanologia.prolog}
...
en lisp, pour définir un arbre binaire, nous ferons simplement: \\[0.2cm]
\begin{lstlisting}[language=Lisp]
(defparameter *my-tree* '(10 (5 3 7) (15 (12 nil 14) (17 nil 20))))
\end{lstlisting}
...
Cet algorithme de recherche, inventé par Edsger Dijkstra dans les années 50 marche de la manière suivante: \\[0.5cm]
...
Fort heureusement, des mathématiciens ont trouvé la solution à ce problème: {\bf Créer une heuristique!} \\
...
une mauvaise heuristique pourrait nous faire retirer trop de noeuds d'une solution potentielle, et ainsi, produire des solutions non-optimales. \\
